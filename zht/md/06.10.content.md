...
![衣蛾／蛀蟲](../json/images/WEB-0646_moth_larva.jpg)
...
![衣蛾／蛀蟲](../json/images/WEB-0644_moth.jpg)
...
JOB 4:19 ：對於這節經文的最後一部分，大多數譯本都依照希伯來文本來翻譯，「他們像飛蛾一樣，很容易就被壓碎了。」

JOB 27:18 ：對於這節經文的前半部分，大多數譯本都遵循《七十士譯本》和《敘利亞文譯本》，解作「他把房屋建造的像蜘蛛網一樣」，而不是像希伯來文所寫的：「他像蛾一樣建造房屋。」然而，如果蛾蛹也稱為*‘ash* ，那麼這段希伯來文可以解作「他把房屋建造的像蛾繭一樣」，基本上就與希臘文和敘利亞文譯本的詩歌意象相同。

JAS 5:2 ：這節經文使用了一個動詞，意思是「被飛蛾吃了」，其中包含*sēs* 這個名詞的衍生詞。
